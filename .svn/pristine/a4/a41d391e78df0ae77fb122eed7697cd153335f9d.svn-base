<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="PasteFilm.aspx.cs" Inherits="Product_PasteFilm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />制造模块-贴膜<asp:Label ID="lblWorksiteID" runat="server" CssClass="hide">M50</asp:Label>
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
