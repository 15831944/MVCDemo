...
public partial class Product_UVCompleteCheck : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            CommonClass.isAllow(User.Identity.Name, this, "UV成型检验");
    ...
    private void setddl(string workshop,string eqp)
    {
        ...
        CRUD.SetEqpDDL(ddlEqp, ddlWorkshop.SelectedValue, "M45");//获取UV成型的eqp
        ...
        FilmCRUD.setDDLQCResult(ddlHeightDifferenceResult);
        FilmCRUD.setDDLQCResult(ddlPenetranceResult);
        FilmCRUD.setDDLQCResult(ddlThinknessResult);
        FilmCRUD.setDDLQCResult(ddlPencilHardnessFrontResult);
        FilmCRUD.setDDLQCResult(ddlPencilHardnessBackResult);
        FilmCRUD.setDDLQCResult(ddlBrilliancyResult);
        FilmCRUD.setDDLQCResult(ddlTDHazeResult);
        #endregion
    }
    protected void btnEnter_Click(object sender, EventArgs e)
    {
        ...
        lotDt = null;
        lotDt = CRUD.getStationInfo(originalLot, "M45");
