<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="WIP.aspx.cs" Inherits="Mould_WIP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />模具模块-WIP<asp:Label ID="lblWorksiteID" runat="server" CssClass="hide">M25</asp:Label>
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
