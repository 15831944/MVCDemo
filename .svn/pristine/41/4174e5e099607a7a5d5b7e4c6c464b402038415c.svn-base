...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //var $bt = $("#txtBt");
            //var $et = $("#txtEt");
            //$bt.val("2016-01-01 08:08:00");
            //alert($bt.val())
        })
        function tst() {

            var $txt1 = $("#txt1");
            var bt = document.getElementById("<%=txtBt.ClientID%>");
            alert(bt.value);
            $txt1.val("333")
        }
    </script>
        ...
        <div id="right_menu">
            ...
            <div id="button">
                <ul>
                    ...
                    <%--                    <li>
                        <asp:Button ID="btnEdit" runat="server" Text="查询"
                ...
                <tr>
                    <td>
                        ...
                        <asp:DropDownList ID="ddlMethod" runat="server" CssClass="txtinfo">
                            <asp:ListItem>面积</asp:ListItem>
                            <asp:ListItem>卷数</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>&nbsp;</td>
                    <td></td>
            ...
            <div align="center">
                ...
                <asp:GridView ID="grd" runat="server" Width="100%" CellPadding="4" CellSpacing="1" EnableModelValidation="True" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" ShowFooter="true" OnRowDataBound="grd_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="sqty" HeaderText="S Grade" />
