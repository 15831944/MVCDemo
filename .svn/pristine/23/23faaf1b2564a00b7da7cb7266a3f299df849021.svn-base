<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="MouldLotHistory.aspx.cs" Inherits="Report_MouldLotHistory" %>
    ...
    <div id="content">
        <fieldset style="border-color: #e8e8e8; border-style: solid; border-width: 1px 1px 1px 1px;">
            ...
            <table class="tb">
                <tr>
                    <td>
                        <label class="labelinfo">模具批次号：</label>
            ...
            <div align="center">
                ...
                <asp:GridView ID="grd" runat="server" Width="100%" CellPadding="4" CellSpacing="1" EnableModelValidation="True" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" >
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="createtime" HeaderText="作业时间" />
                        <asp:BoundField DataField="createuser" HeaderText="作业人员" />
