<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="OutWard.aspx.cs" Inherits="Mould_OutWard" %>
    ...
    <script type="text/javascript">
        ...
        function PrintLabel() {
            ...
            if (!window.ActiveXObject) {
                alert("请使用IE浏览器打印标签");
                window.location.replace("../Mould/OutWard.aspx");
            }
            ...
            alert("操作成功，生成外发标签：" + document.getElementById('<%=txtLabelInfo.ClientID %>').value);
            //刷新页面
            window.location.replace("../Mould/OutWard.aspx");
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />模具模块-外发<asp:Label ID="lblWorksiteID" runat="server" CssClass="hide">M10</asp:Label>
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
