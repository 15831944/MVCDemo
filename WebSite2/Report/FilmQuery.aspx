<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="FilmQuery.aspx.cs" Inherits="Report_FilmQuery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />报表模块-卷材查询
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
