<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="CreateLot.aspx.cs" Inherits="Mould_CreateLot" %>
...
<%--                if (document.getElementById("<%=txtLotLength.ClientID%>").value == "") {
        ...
        function CheckData() {
            ...
            var validlength = document.getElementById("<%=txtLotLength.ClientID%>").value;
            var validwidth = document.getElementById("<%=txtLotWidth.ClientID%>").value;
            ...
            <div align="center">
                <asp:GridView ID="grd" runat="server" CellPadding="4" CellSpacing="1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="mouldid" HeaderText="批次号" />
