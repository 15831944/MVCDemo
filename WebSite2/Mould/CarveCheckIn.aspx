<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="CarveCheckIn.aspx.cs" Inherits="Mould_CarveCheckIn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function CheckData() {
            ...
            //document.getElementById("<%=btnSaveClose.ClientID%>").disabled = true;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />模具模块-精雕进站<asp:Label ID="lblWorksiteID" runat="server" CssClass="hide"></asp:Label>
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
