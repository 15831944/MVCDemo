    ...
    <div id="content">
        <fieldset style="border-color: #e8e8e8; border-style: solid; border-width: 1px 1px 1px 1px;">
            ...
            <table class="tb">
                ...
                <%--<tr>
                    <td>
                        <label class="labelinfo">出库通知单号：</label>
                        <asp:DropDownList ID="ddlShipmentNotice" runat="server" CssClass="txtinfo" AutoPostBack="True" OnSelectedIndexChanged="ddlShipmentNotice_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
        ...
        <!--出库通知单信息-->
        <fieldset>
            <legend>出库通知单信息</legend>
            <div align="center">

                <asp:GridView ID="grdShipmentNotice" runat="server" Width="100%" CellPadding="4" CellSpacing="1" EnableModelValidation="True" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                    ...
                    <Columns>                       
                        <asp:BoundField DataField="type" HeaderText="规格" />
                        <asp:BoundField DataField="shipmentqty" HeaderText="通知单米数" />
                    </Columns>
