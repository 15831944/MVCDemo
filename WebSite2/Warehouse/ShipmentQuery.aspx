<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ShipmentQuery.aspx.cs" Inherits="Warehouse_ShipmentQuery" %>
        ...
        <fieldset style="border-color: #e8e8e8; border-style: solid; border-width: 1px 1px 1px 1px;">
            ...
            <table class="tb">
                <tr>
                    ...
                    <td>
                        <label class="labelinfo">出库开始时间：</label>
                    ...
                    <td>
                        <label class="labelinfo">出库结束时间：</label>
