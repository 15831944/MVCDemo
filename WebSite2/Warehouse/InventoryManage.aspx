            ...
            <table class="tb">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtWarehouseID" runat="server" CssClass="txtinfo"></asp:TextBox>
                    </td>
                    <td>
            ...
            <div align="center">
                ...
                <asp:GridView ID="grd" runat="server" Width="100%" CellPadding="4" CellSpacing="1" EnableModelValidation="True" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="length" HeaderText="有效长度" />
                        <asp:BoundField DataField="width" HeaderText="有效宽幅" />
                        <asp:BoundField DataField="warehousetime" HeaderText="入库时间" />
                        <asp:BoundField DataField="warehouseID" HeaderText="入库单号" />
