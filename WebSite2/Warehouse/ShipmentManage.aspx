<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ShipmentManage.aspx.cs" Inherits="Warehouse_InventoryManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />仓管模块-预出库管理
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
                    <li>
                     ...
                     <%--                  <li>
                        <asp:Button ID="btnEdit" runat="server" Text="添加"
                            CssClass="daohang_btn_edit" /></li>
                    <li>
                        <asp:Button ID="btnReset" runat="server" OnClientClick="ClearAllTextBox()" Text="删除"
    ...
    <div id="content">
        <fieldset style="border-color: #e8e8e8; border-style: solid; border-width: 1px 1px 1px 1px;">
            ...
            <table class="tb">
                <tr>
                    ...
                    <td>
                        <label class="labelinfo">预出库开始时间：</label>
                    ...
                    <td>
                        <label class="labelinfo">预出库结束时间：</label>
        ...
        <fieldset>
            ...
            <div align="center">
                ...
                <asp:GridView ID="grd" runat="server" Width="100%" CellPadding="4" CellSpacing="1" EnableModelValidation="True" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnRowDataBound="grd_RowDataBound" OnRowCommand="grd_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="showcell" HeaderStyle-CssClass="showcell">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="btnDetail" CommandName="Detail" CommandArgument='<%# Eval("shipmentID").ToString() %>'>辅助列</asp:LinkButton>
                            </ItemTemplate>
