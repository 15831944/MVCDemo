<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="UVBackCheck.aspx.cs" Inherits="Product_UVBackCheck" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />制造模块-UV背涂检验
                <asp:Label ID="lblWorksiteID" runat="server" CssClass="hide">M42</asp:Label>
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
