<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="UVBack.aspx.cs" Inherits="Product_UVBack" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="submenu">
        <div id="right_menu">
            <div id="daohang">
                <img src="../image/home.png" />制造模块-UV背涂
                <asp:Label ID="lblWorksiteID" runat="server" CssClass="hide">M40</asp:Label>
            </div>
            <!--end daohang-->
            <div id="button">
                <ul>
            ...
            <table class="tb">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtMouldLot" runat="server" CssClass="txtinfo"></asp:TextBox>
            ...
            <table class="tb">
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="txtHaze" CssClass="txtinfo" runat="server" BackColor="#e8e8e8"></asp:TextBox>
                    </td>
                    <td></td>
                    <td></td>
                </tr>
